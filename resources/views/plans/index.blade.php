...
<div class="py-2 row justify-content-center">
    <div class="col-md-8">
        @if(Auth::check())
        <p>En choisissant une formule d'abonnement, votre groupe pourra disposer d'une capacité de stockage plus importante pour le téléchargement de fichiers audio, photos...</p>
        <p class="note">By choosing a subscription plan, the band will dispose of more capacity storage for its uploaded media files.</p>
        <br>
