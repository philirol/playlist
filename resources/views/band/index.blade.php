...
<div class="container-fluid">
  <div class="row" style="font-weight:bold;">
        <div class="rounded-left col-sm-3 bg-secondary" style="padding-top:15px"><p>@lang('Groupe')</p></div>
        ...
        <div class="col-sm-3 bg-secondary" style="padding-top:15px"><p>@lang('Ville')</p></div>
        <div class="col-sm-2 bg-secondary" style="padding-top:15px"><p>@lang('Code postal')</p></div>
    ...
    <div class="row">
        ...
        <div class ="col-sm-3 bg-light"><p style="margin-top:15px;">{{ $band->ville->ville_nom }}</p></div>
        <div class ="col-sm-2 bg-light"><p style="margin-top:15px;">{{ $band->ville->ville_code_postal }}</p></div>
